package com.ogryzok.semendestiller.container;
...
public class ContainerSemenDestiller extends Container {
    private final TileSemenDestillerBase tile;

    public ContainerSemenDestiller(InventoryPlayer playerInventory, TileSemenDestillerBase tile) {
        this.tile = tile;
